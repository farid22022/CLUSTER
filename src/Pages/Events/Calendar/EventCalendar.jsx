...
const EventCalendar = () => {
  ...
  // Sample events data (in a real app, this would come from a calendar API)
  const events = [
    {
      id: 1,
      title: "SynergyX Datathon Kickoff",
      date: "2025-06-01",
      time: "3:00 PM - 5:00 PM",
      location: "CSE Building, Room 302",
      description: "Official kickoff event for the Datathon competition with guest speakers",
    },
    {
      id: 2,
      title: "Project Symposium Workshop",
      date: "2025-06-15",
      time: "10:00 AM - 12:00 PM",
      location: "Innovation Lab",
      description: "Learn how to prepare your project for the symposium showcase",
    },
    {
      id: 3,
      title: "IUPC Practice Session",
      date: "2025-07-10",
      time: "2:00 PM - 6:00 PM",
      location: "Computer Lab 4",
      description: "Practice session for upcoming programming competition",
    }
  ];
              ...
              >
                {events.map((event) => (
                  ...
                  >
                    ...
                    <p className="text-blue-200 mt-3">{event.description}</p>
                  </motion.div>
                ))}
              </motion.div>
